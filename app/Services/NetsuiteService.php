...
require_once app_path().'/Services/Helper/Oauth256.php';

use Illuminate\Support\Facades\Http as Httplaravel;
use OAuthConsumer;
use OAuthRequest;
...
class NetsuiteService
{
    ...
    public static function postRequest($script, $json, $type_ambiente = null)
    {
    ...
    public static function getRequest($script, $id, $start, $end, $type = '', $type_ambiente = null)
    {
        $ambiente = ($type_ambiente == null) ? config('app.ambiente') : $type_ambiente;
        if ($ambiente == 'local') {
            $NETSUITE_DEPLOY_ID = '1';
